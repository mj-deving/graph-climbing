...
- After durable lane seal, release its worker's mutating lease but retain the cohort reservation through the join. The worker may claim another ready candidate from the epoch only when compatible with every pending reservation; stragglers block their join and dependents, not independent frontiers.
