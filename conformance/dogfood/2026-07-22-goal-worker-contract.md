...
- the identical worker runtime is 1,100 characters or less and retains reconstruction, ledger pre/post-claim validation, ledgerless bounded local selection, one-lease execution, verification, reconciliation, completion, and fail-closed stop boundaries;
